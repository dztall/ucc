...
//------------------------------------------------------------------------------
const QR_Vertex firstPolygon_Red[3] =
{
...
//------------------------------------------------------------------------------
const QR_Vertex firstPolygon_Blue[3] =
{
...
//------------------------------------------------------------------------------
const QR_Vertex secondPolygon_Red[3] =
{
...
//------------------------------------------------------------------------------
const QR_Vertex secondPolygon_Blue[3] =
{
...
//------------------------------------------------------------------------------
void Copy(QR_Vector3* pS, QR_Vector3* pD)
{
    pD->m_X = pS->m_X;
    pD->m_Y = pS->m_Y;
    pD->m_Z = pS->m_Z;
...
//------------------------------------------------------------------------------
void DistanceToPlane(QR_Vector3* pP, QR_Plane* pPl, float* pR)
{
...
//------------------------------------------------------------------------------
int PlaneIntersectLine(QR_Plane* pPl, QR_Vector3* pV1, QR_Vector3* pV2, QR_Vector3* pP)
{
...
//------------------------------------------------------------------------------
void GetShortestDistance(QR_Vector3* pL1S, QR_Vector3* pL1E,
                         QR_Vector3* pL2S, QR_Vector3* pL2E, float* pEpsylon, float* pR)
{
...
//------------------------------------------------------------------------------
int Intersect(QR_Vector3* pP1V1, QR_Vector3* pP1V2, QR_Vector3* pP1V3,
              QR_Vector3* pP2V1, QR_Vector3* pP2V2, QR_Vector3* pP2V3)
{
         ...
         (plane1.m_D == -plane2.m_D)))
    {
        ...
        QR_Vector3 v1v2LineS;
        QR_Vector3 v1v2LineE;
        QR_Vector3 v2v3LineS;
        QR_Vector3 v2v3LineE;
        QR_Vector3 v3v1LineS;
        QR_Vector3 v3v1LineE;
        QR_Vector3 ov1ov2LineS;
        QR_Vector3 ov1ov2LineE;
        QR_Vector3 ov2ov3LineS;
        QR_Vector3 ov2ov3LineE;
        QR_Vector3 ov3ov1LineS;
        QR_Vector3 ov3ov1LineE;
...
//------------------------------------------------------------------------------
void MatrixMultiply(QR_Matrix* pM1, QR_Matrix* pM2, QR_Matrix* pR)
{
    for (int i = 0; i < 4; ++i)
        for (int j = 0; j < 4; ++j)
...
//------------------------------------------------------------------------------
void GetOrtho(float* pMaxX, float* pMaxY, QR_Matrix* pM)
{
...
//------------------------------------------------------------------------------
void ApplyMatrixToVector(QR_Matrix* pM, QR_Vector3* pV, QR_Vector3* pR)
{
...
void on_GLES2_Render()
{
    ...
    QR_Matrix modelViewMatrixPoly1;
    QR_Matrix modelViewMatrixPoly2;
    ...
    if (collisionDetected)
    {
        ...
        vertexCount = sizeof(firstPolygon_Red) / sizeof(QR_Vertex);
    }
    else
    {
        pCoords     = &firstPolygon_Blue[0].m_Position[0];
        pColors     = &firstPolygon_Blue[0].m_Color[0];
        vertexCount = sizeof(firstPolygon_Blue) / sizeof(QR_Vertex);
    }
    ...
    if (collisionDetected)
    {
        ...
        vertexCount = sizeof(secondPolygon_Red) / sizeof(QR_Vertex);
    }
    else
    {
        pCoords     = &secondPolygon_Blue[0].m_Position[0];
        pColors     = &secondPolygon_Blue[0].m_Color[0];
        vertexCount = sizeof(secondPolygon_Blue) / sizeof(QR_Vertex);
    }
