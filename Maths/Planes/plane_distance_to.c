/*****************************************************************************
 * ==> Calculate a distance from a point p to a plane -----------------------*
 *****************************************************************************
 * Description : Calculate a distance from a point p to a plane              *
...
void main()
{
    ...
    float dToPlane;
    DistanceToPlane(&p, &plane, &dToPlane);
    ...
    printf("The distance from p to plane is %f", dToPlane);
}
//------------------------------------------------------------------------------
