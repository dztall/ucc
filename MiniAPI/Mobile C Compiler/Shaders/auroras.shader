...
// downloaded from https://www.shadertoy.com/view/XtGGRt
...
vec4 aurora(vec3 ro, vec3 rd)
{
    ...
    //return clamp(pow(col, vec4(1.3)) * 1.5, 0.0, 1.0);
    //return clamp(pow(col, vec4(1.7)) * 2.0, 0.0, 1.0);
    //return clamp(pow(col, vec4(1.5)) * 2.5, 0.0, 1.0);
    //return clamp(pow(col, vec4(1.8)) * 1.5, 0.0, 1.0);

    //return smoothstep(0.0, 1.1, pow(col, vec4(1.0)) * 1.5);
    return col * 1.8;
    //return pow(col, vec4(1.0)) * 2.0;
}
